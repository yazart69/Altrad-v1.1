...
export default function ChantierDetail() {
  ...
  const addSubTask = async (parentId: string) => { 
      ...
      // Ajout de "avancement: 0" par défaut
  ...
  // NOUVEAU: Mettre à jour l'avancement (%) d'une sous-tâche
  ...
  return (
    <div className="min-h-screen bg-[#f0f3f4] font-['Fredoka'] pb-20 text-gray-800 ml-0 md:ml-0 transition-all print:bg-white print:p-0 print:m-0 print:w-full">
      ...
      <div className="max-w-7xl mx-auto p-4 md:p-6 space-y-6 print:max-w-none print:p-2">
        ...
        {/* CONTENU ONGLET TACHES & PLANNING */}
        {activeTab === 'planning' && (
                            ...
                            <div key={t.id} className="relative">
                                <div className="flex items-center gap-4 mb-2">
                                    ...
                                    <div className="flex-1 bg-gray-100 h-8 rounded-full relative overflow-hidden">
                                        {/* Tâche Principale: Affichage classique */}
                                ...
                                {t.subtasks && t.subtasks.map((st: any) => {
                                    // Calcul sécurisé pour ne pas déborder
                                    const leftPos = (new Date(st.date || new Date()).getDate() % 30) * 3;
                                    const targetWidth = Math.max(15, st.heures * 2); // 15 minimum pour que le texte rentre
                                    const safeWidth = Math.min(targetWidth, 100 - leftPos); // Empêche de dépasser 100% de l'écran
                                    ...
                                    return (
                                        <div key={st.id} className="flex items-center gap-4 mb-1 pl-8 relative group">
                                            ...
                                            <div className="flex-1 bg-gray-50 h-6 rounded-full relative overflow-hidden border border-gray-100">
                                                {/* Barre Gantt avec limite safeWidth */}
                                                <div 
                                                ...
                                                >
                                                    {/* Filtre sombre pour indiquer l'avancement en % à l'intérieur de la barre */}
        ...
        {activeTab === 'suivi' && (<div className="animate-in fade-in slide-in-from-bottom-4 space-y-6 print:space-y-4">...</div>)}
