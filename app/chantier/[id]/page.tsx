                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white rounded-[30px] p-6 shadow-sm border border-gray-100 space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="col-span-2"><label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Chargé d'Affaire (Responsable)</label><div className="flex items-center bg-gray-50 rounded-xl px-2 mt-1"><Briefcase size={16} className="text-gray-400 mr-2"/><input value={chantier.responsable || ''} onChange={e => setChantier({...chantier, responsable: e.target.value})} className="w-full bg-transparent p-3 font-bold outline-none" placeholder="Nom du responsable..." /></div></div>
