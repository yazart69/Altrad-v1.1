...
import { ShoppingCart, CalendarClock, MessageSquareWarning, MapPin, AlertTriangle, Truck, FileX, ShieldAlert } from 'lucide-react';
...
export default function MiddleTiles({ alertsCount = 0 }: MiddleTilesProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 h-full font-['Fredoka']">
      ...
      {/* TUILE 1 : MATÉRIEL */}
      <div className="bg-[#0984e3] rounded-[25px] p-5 text-white relative overflow-hidden flex flex-col shadow-lg border border-white/10 group">
      ...
      {/* TUILE 2 : LOCATIONS */}
      <div className="bg-[#6c5ce7] rounded-[25px] p-5 text-white flex flex-col shadow-lg border border-white/10 group">
      ...
      {/* TUILE 3 : CONFORMITÉ (DYNAMIQUE & DÉTAILLÉE) */}
      <div className={`rounded-[25px] p-5 text-white flex flex-col transition-all duration-500 shadow-lg border border-white/10 ${totalConformite > 0 ? 'bg-[#d63031] animate-pulse' : 'bg-gray-800'}`}>
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar space-y-3">
          {/* Score Global */}
          <div className="flex items-center justify-center py-2 bg-black/20 rounded-2xl">
