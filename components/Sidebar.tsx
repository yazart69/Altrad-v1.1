...
import { LayoutDashboard, ShoppingCart, CalendarDays, Settings, LogOut, PackageSearch } from 'lucide-react';
...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { name: 'Achats & Commandes', icon: <ShoppingCart size={22} />, path: '/commandes' },
    { name: 'Réglages', icon: <Settings size={22} />, path: '/reglages' },
  ];

  return (
    <div className="h-full w-[250px] bg-white rounded-[30px] flex flex-col p-6 shadow-sm font-['Fredoka'] ml-4 my-4">
      {/* Logo */}
      <div className="flex items-center gap-3 mb-10 px-2">
        <div className="w-10 h-10 bg-[#d63031] rounded-xl flex items-center justify-center text-white font-black text-xl">
          A
        </div>
